...
| 이름 | 업무 |
| :---: | --- |
| 👨‍🎓<br>이<br>정<br>민 | 1. 홈페이지, 회원정보 페이지, 회원가입 페이지, 상품 페이지, 상품 상세 페이지, 상품 리뷰 작성 페이지, 결제 페이지(결제목록), 결제취소 페이지 UI 디자인<br>2. 코드 리팩터링 및 주석 정리<br>3. 발표 |
| 👨‍🎓<br>임<br>성<br>준 | 1. 시나리오 수립<br>2. 관리자 메인 페이지, 상품관리 페이지, 상품등록 폼 페이지, 회원관리 페이지, 관리자 로그인 페이지, 관리자 환경설정 페이지, 관리자 Todo 페이지, 추가 관리자 관리 페이지, 추가 관리자 등록 페이지, 결제 내역 페이지, 매장 위치 페이지, 결제 페이지(결제목록), 상품 리뷰 작성 페이지, 상품상세 페이지 UI 디자인<br>3. 상품 리뷰 데이터베이스 구축<br>4. 관리자 Todo 데이터베이스 구축<br>5. 개인결제내역 기능구현<br>6. 회원정보 페이지 - 구매내역 기능 구현<br>7. 상품 리뷰 등록 및 삭제, 평점 계산 기능 구현<br>8. 매장 위치 검색 기능 구현<br>9. 관리자 다크모드 기능 구현<br>10. 회원, 상품, 관리자, 구매내역 알림창 기능 구현<br>11. 관리자 Todo 추가, 삭제, 조회 기능 구현<br>12. 코드 리팩터링 및 주석 정리<br>13. 발표 자료 준비 및 발표<br>14. 전체 문서 작업 |
| 👨‍🎓<br>오<br>자<br>현 | 1. 상품 데이터베이스 구축<br>2. QR코드 생성 및 스캔 기능 구현<br>3.상품 관리 기능 구현(상품 등록, 수정 삭제)<br>4. 상품 관리 검색 기능 구현<br>5. 상품페이지 기능 구현<br>6. 문서 작업<br>7. 발표<br>8. 코드 리팩터링 및 주석 정리 |
| 👨‍🎓<br>이<br>석<br>재 | 1. 사용자 데이터베이스 구축<br>2. 결제 내역 데이터베이스 구축<br>3. 회원가입 및 로그인 기능 구현 (회원 / 비회원)<br>4. 상품 결제 기능 구현<br>5. 회원 포인트 적립/차감 기능 구현<br>6. 회원관리 페이지 - 회원 정보 기능 구현<br>7. 회원 탈퇴 기능 구현<br>8. 관리자/회원 세션 처리 기능 구현<br>9. 회원 관리 검색 기능 구현<br>10. 개인결제내역 기능 구현<br>11. 결제 내역 조회(관리자) 및 환불 처리 기능 구현<br>12. 최초 관리자 및 추가 관리자 등록, 삭제 기능 구현<br>13. 문서 작업<br>14. 발표 |
...
* ⚙ 관리자 기능
	* 관리자 로그인/로그아웃
	* 최초 관리자 및 추가 관리자 등록, 삭제
	* 관리자 다크모드
	* 팀장 연락 기능
	* 앱QR 생성 기능
	* 관리자 Todo 추가, 삭제, 조회
	* 회원 관리(회원 목록 조회, 회원 상세정보 열람, 회원 정보 검색, 회원 탈퇴 처리)
	* 상품 관리(상품 등록, 상품 QR 생성, 상품 검색, 상품 수정, 상품 삭제)
	* 결제 관리(결제 목록 조회, 결제 상세정보 열람, 결제 정보 검색, 결제 취소 처리)
<br>

## 📃 ERD 설계 및 테이블 구조

### 📃🔨 ERD 설계
![ERD](https://github.com/yuhan19plus/AndroidProjects/blob/main/md_res/ERD.png?raw=true)

<br>

### 🛍📃 Products 테이블
![products_Table](https://github.com/yuhan19plus/AndroidProjects/blob/main/md_res/products_Table.png?raw=true)
